...
if(isset($_POST["Volunteer_ID"]) && !empty($_POST["Volunteer_ID"])){
    ...
    if($stmt = mysqli_prepare($link, $sql)){
        ...
        mysqli_stmt_bind_param($stmt, "i", $param_Volunteer_ID);
        
        // Set parameters
        $param_Volunteer_ID= trim($_POST["Volunteer_ID"]);
        
        // Attempt to execute the prepared statement
        if(mysqli_stmt_execute($stmt)){
            // Records deleted successfully. Redirect to landing page
            echo "Volunteer record deleted successfully";
    ...
    if(empty(trim($_GET["Volunteer_ID"]))){
